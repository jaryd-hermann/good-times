...
**PostHog Setup:**
- Get your API key from [PostHog Dashboard](https://app.posthog.com) → Project Settings → Project API Key
- For EU cloud, use `https://eu.i.posthog.com` as host
- PostHog is optional - app will work without it (analytics will be disabled)
